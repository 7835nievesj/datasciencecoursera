---
title: "Return ranking for subsets tutorial"
author: "Jose Nieves"
date: "March 1, 2016"
...
Considering cities.csv, in this case we want to know what's the __second city by size of each country__, without knowing the dimension of our database and the number of countries. We want a data frame with these cities as final output.
...
### Writing __rank.by.country__ function

```{r}
rank.by.country <- function(data,column,rank){
...
```{r}
rank.by.country(data,3,1)
rank.by.country(data,3,2)
```
